...
exports.GameStore = {
    ...
    getPublics: function () { return Object.entries(gamesMap).map(function (p) { return p[1]; }).filter(function (g) { return g.public && !g.meta.running; }).map(function (g) { return ({ name: g.name, player: g.meta.players }); }); },
