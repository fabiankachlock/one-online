...
exports.HandleCreateGame = void 0;
var game_js_1 = require("../../game/game.js");
var helper_1 = require("../../helper");
var logging_1 = require("../../logging");
var preGameMessages_1 = require("../../preGameMessages");
var HandleCreateGame = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if (helper_1.requireLogin(req, res))
            return [2 /*return*/];
        if (!name || !password) {
            logging_1.Logging.Game.info("[Created] call with missing information");
