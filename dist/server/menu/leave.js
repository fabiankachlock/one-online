...
exports.HandleLeaveGame = void 0;
...
var HandleLeaveGame = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (game) {
            ...
            logging_1.Logging.Game.warn("[Leave] " + req.session.userId + " tried leaving nonexisting game " + computedGameId);
            // reset session
            req.session.gameId = '';
            req.session.activeToken = '';
