...
exports.HandleRegisterPlayer = void 0;
var logging_1 = require("../../logging");
var playerStore_1 = require("../../store/implementations/playerStore");
var uuid_1 = require("uuid");
var HandleRegisterPlayer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (name) {
            ...
            logging_1.Logging.Player.info("player " + newId + " registered under name " + name);
...
exports.HandleRegisterPlayer = HandleRegisterPlayer;
