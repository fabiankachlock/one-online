...
exports.HandleGameStop = void 0;
var helper_1 = require("../../helper");
var logging_1 = require("../../logging");
var preGameMessages_1 = require("../../preGameMessages");
var gameStore_1 = require("../../store/implementations/gameStore");
var HandleGameStop = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, game;
    return __generator(this, function (_a) {
        ...
        if (game) {
            logging_1.Logging.Game.info("[Stop] " + id);
            game.stop();
            res.send('');
        }
        else {
            logging_1.Logging.Game.warn("[Stop] tried stopping nonexisting game " + id);
            preGameMessages_1.PreGameMessages.error(res, 'Error: Game cannot be found');
        }
        return [2 /*return*/];
    });
}); };
exports.HandleGameStop = HandleGameStop;
