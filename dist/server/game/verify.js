...
exports.HandleGameVerify = void 0;
var helper_1 = require("../../helper");
var logging_1 = require("../../logging");
var preGameMessages_1 = require("../../preGameMessages");
var gameStore_1 = require("../../store/implementations/gameStore");
var HandleGameVerify = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, player, game;
    return __generator(this, function (_a) {
        ...
        if (game === null || game === void 0 ? void 0 : game.verify(player)) {
            ...
            logging_1.Logging.Game.warn("[Verify] tried verifying player " + player + " on nonexisting game " + id);
            preGameMessages_1.PreGameMessages.error(res, 'Error: Not allowed to access game');
        }
        return [2 /*return*/];
    });
}); };
exports.HandleGameVerify = HandleGameVerify;
