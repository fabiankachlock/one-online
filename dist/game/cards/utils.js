...
exports.VALID_CARD_TYPES = Object.entries(type_js_1.CARD_TYPE)
    .map(function (_a) {
    var _b = __read(_a, 2), t = _b[1];
    return t;
})
    .filter(function (t) { return t !== type_js_1.CARD_TYPE.none; });
exports.VALID_CARD_COLOR = Object.entries(type_js_1.CARD_COLOR)
    .map(function (_a) {
...
exports.CARD_DECK = __spreadArray(__spreadArray(__spreadArray([], __read(exports.ALL_CARDS)), __read(exports.ALL_CARDS.filter(function (c) { return c.type !== type_js_1.CARD_TYPE.n0; }))), __read([type_js_1.CARD_TYPE.wild, type_js_1.CARD_TYPE.wildDraw2, type_js_1.CARD_TYPE.wildDraw4]
